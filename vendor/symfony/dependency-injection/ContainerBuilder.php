 ...
 */
namespace SmokeTestgen202507\Symfony\Component\DependencyInjection;

use SmokeTestgen202507\Composer\InstalledVersions;
use SmokeTestgen202507\Symfony\Component\Config\Resource\ClassExistenceResource;
use SmokeTestgen202507\Symfony\Component\Config\Resource\ComposerResource;
use SmokeTestgen202507\Symfony\Component\Config\Resource\DirectoryResource;
use SmokeTestgen202507\Symfony\Component\Config\Resource\FileExistenceResource;
use SmokeTestgen202507\Symfony\Component\Config\Resource\FileResource;
use SmokeTestgen202507\Symfony\Component\Config\Resource\GlobResource;
use SmokeTestgen202507\Symfony\Component\Config\Resource\ReflectionClassResource;
use SmokeTestgen202507\Symfony\Component\Config\Resource\ResourceInterface;
...
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Attribute\Target;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Compiler\Compiler;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Compiler\PassConfig;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Exception\BadMethodCallException;
...
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Extension\ExtensionInterface;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\LazyServiceInstantiator;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\ParameterBag\EnvPlaceholderParameterBag;
...
use SmokeTestgen202507\Symfony\Component\ExpressionLanguage\ExpressionFunctionProviderInterface;
/**
...
class ContainerBuilder extends Container implements TaggedContainerInterface
{
    ...
    private function createService(Definition $definition, array &$inlineServices, bool $isConstructorArgument = \false, ?string $id = null, $tryProxy = \true)
    {
        ...
        if (\true === $tryProxy && $definition->isLazy() && ['Closure', 'fromCallable'] !== $definition->getFactory() && !($tryProxy = !($proxy = $this->proxyInstantiator = $this->proxyInstantiator ?? new LazyServiceInstantiator()) || $proxy instanceof RealServiceInstantiator)) {
