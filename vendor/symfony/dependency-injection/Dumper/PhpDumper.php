 ...
 */
namespace SmokeTestgen202507\Symfony\Component\DependencyInjection\Dumper;

use SmokeTestgen202507\Composer\Autoload\ClassLoader;
use SmokeTestgen202507\Symfony\Component\Config\Resource\FileResource;
...
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Argument\LazyClosure;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Compiler\CheckCircularReferencesPass;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Container;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\ContainerBuilder;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\ContainerInterface;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Definition;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Exception\EnvParameterException;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Exception\LogicException;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Exception\RuntimeException;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\ExpressionLanguage;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\DumperInterface;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\LazyServiceDumper;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Loader\FileLoader;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Parameter;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Reference;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\ServiceLocator as BaseServiceLocator;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\TypedReference;
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Variable;
use SmokeTestgen202507\Symfony\Component\ErrorHandler\DebugClassLoader;
...
use SmokeTestgen202507\\Symfony\\Component\\DependencyInjection\\Argument\\RewindableGenerator;
use SmokeTestgen202507\\Symfony\\Component\\DependencyInjection\\ContainerInterface;
use SmokeTestgen202507\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
...
use SmokeTestgen202507\\Symfony\\Component\\DependencyInjection\\Dumper\\Preloader;
...
EOF;
                foreach ($this->preload as $class) {
                    if (!$class || \strpos($class, '$') !== \false || \in_array($class, ['int', 'float', 'string', 'bool', 'resource', 'object', 'array', 'null', 'callable', 'iterable', 'mixed', 'void', 'never'], \true)) {
                        continue;
                    }
...
, $this->container->getDefinition($id)->isPublic() ? 'services' : 'privates', $this->doExport($id));
    ...
    private function addNewInstance(Definition $definition, string $return = '', ?string $id = null, bool $asGhostObject = \false) : string
    {
        ...
        if ($callable = $definition->getFactory()) {
            ...
            if (['...'] === $arguments && ('Closure' !== ($class = $definition->getClass() ?: 'Closure') || $definition->isLazy() && ($callable[0] instanceof Reference || $callable[0] instanceof Definition && !$this->definitionVariables->contains($callable[0])))) {
...
use SmokeTestgen202507\\Symfony\\Component\\DependencyInjection\\Container;
use SmokeTestgen202507\\Symfony\\Component\\DependencyInjection\\Exception\\LogicException;
use SmokeTestgen202507\\Symfony\\Component\\DependencyInjection\\Exception\\ParameterNotFoundException;
use SmokeTestgen202507\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
use SmokeTestgen202507\\Symfony\\Component\\DependencyInjection\\ParameterBag\\FrozenParameterBag;
use SmokeTestgen202507\\Symfony\\Component\\DependencyInjection\\ParameterBag\\ParameterBagInterface;
...
EOF;
    ...
    private function addDeprecatedParameters() : string
    {
        ...
        foreach ($deprecated as $param => $deprecation) {
            $code .= '        ' . $this->doExport($param) . ' => [' . \implode(', ', \array_map(\Closure::fromCallable([$this, 'doExport']), $deprecation)) . "],\n";
        }
...
EOF;
    ...
    private function getExpressionLanguage() : ExpressionLanguage
    {
        if (!isset($this->expressionLanguage)) {
            if (!\class_exists(\SmokeTestgen202507\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
    ...
    private function getClasses(Definition $definition, string $id) : array
    {
        ...
        while ($definition instanceof Definition) {
            ...
            if (\is_string($factory) && \strncmp($factory, '@=', \strlen('@=')) !== 0 && \strpos($factory, '::') !== \false) {
