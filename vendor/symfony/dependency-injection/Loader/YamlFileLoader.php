 ...
 */
namespace SmokeTestgen202507\Symfony\Component\DependencyInjection\Loader;
...
use SmokeTestgen202507\Symfony\Component\DependencyInjection\Argument\BoundArgument;
...
use SmokeTestgen202507\Symfony\Component\DependencyInjection\ChildDefinition;
...
use SmokeTestgen202507\Symfony\Component\Yaml\Exception\ParseException;
use SmokeTestgen202507\Symfony\Component\Yaml\Parser as YamlParser;
use SmokeTestgen202507\Symfony\Component\Yaml\Tag\TaggedValue;
use SmokeTestgen202507\Symfony\Component\Yaml\Yaml;
/**
...
class YamlFileLoader extends FileLoader
{
     ...
     * @return \Symfony\Component\DependencyInjection\Definition|\Symfony\Component\DependencyInjection\Alias|null
     */
    private function parseDefinition(string $id, $service, string $file, array $defaults, bool $return = \false, bool $trackBindings = \true)
    {
        ...
        if (isset($service['from_callable'])) {
            ...
            if ('Closure' !== ($service['class'] = $service['class'] ?? 'Closure')) {
                $service['lazy'] = \true;
            }
    ...
    {
        if (!\class_exists(\SmokeTestgen202507\Symfony\Component\Yaml\Parser::class)) {
