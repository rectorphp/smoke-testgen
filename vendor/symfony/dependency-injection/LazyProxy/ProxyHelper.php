 ...
 */
namespace SmokeTestgen202507\Symfony\Component\DependencyInjection\LazyProxy;

trigger_deprecation('symfony/dependency-injection', '6.2', 'The "%s" class is deprecated, use "%s" instead.', ProxyHelper::class, \SmokeTestgen202507\Symfony\Component\VarExporter\ProxyHelper::class);
/**
