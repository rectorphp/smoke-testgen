 ...
 */
namespace SmokeTestgen202507\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'SmokeTestgen202507\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'SmokeTestgen202507\\Mes\\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'SmokeTestgen202507\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'SmokeTestgen202507\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'SmokeTestgen202507\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'SmokeTestgen202507\\Mon\\1'],
        // Default rule
        ['/s$/i', ''],
    ];
