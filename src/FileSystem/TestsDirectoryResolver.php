...
final class TestsDirectoryResolver
{
    ...
    {
        // find test directory
        $unitTestDirectoryFinder = Finder::create()->directories()->name('#unit#i')->in($testDirectory)->depth(0)->getIterator();
    ...
    {
        // find test directory
        $testDirectoryFinder = Finder::create()->directories()->name('#test#i')->in($projectDirectory)->depth(0)->getIterator();
