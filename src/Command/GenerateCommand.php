...
final class GenerateCommand extends Command
{
    ...
    /**
     * @readonly
     * @var \Rector\SmokeTestgen\Templating\TemplateDecorator
     */
    private $templateDecorator;
    public function __construct(TestsDirectoryResolver $testsDirectoryResolver, TestTemplateResolver $testTemplateResolver, TemplateDecorator $templateDecorator)
    {
